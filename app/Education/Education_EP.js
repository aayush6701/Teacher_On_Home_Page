              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-x-6 gap-y-4">
                <div>
                  ...
                  <input
                    ...
                    className="w-full lg:w-[398px] border border-gray-300 rounded-[2px] p-2.5 bg-[#F2F6FB] placeholder-[#8397A6]"
                  />
                </div>
                <div>
                  <label className="block text-sm mb-1 text-[#4E5865]">
                  ...
                  <select className="w-full lg:w-[398px] border border-gray-300 rounded-[2px] p-2.5 bg-[#F2F6FB] text-[#8397A6]">
                ...
                <div>
                  ...
                  <div className="flex gap-4">
                    <div className="relative w-full lg:w-[194px]">
                      <select className="w-full border border-gray-300 rounded-[2px] p-2.5 bg-[#F2F6FB] pr-10 text-[#8397A6]">
