...
export default function Navbar() {
  ...
  return (
    <nav className="flex items-center justify-between p-4 bg-white shadow-lg" style={{ paddingLeft: '2rem', paddingRight: '2rem', paddingTop: '3px', paddingBottom: '3px' }}>
      {/* Logo Section */}
      ...
      <div className="flex items-center space-x-4">
        {/* Search Bar */}
        <div className="flex items-center border border-gray-300 rounded-md" style={{ width: '176px', height: '54px' }}>
